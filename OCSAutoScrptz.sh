...
read -p "Password: " -e -i beeggy DatabasePass
echo ""
...
echo "clear" >> .bashrc
echo 'echo -e "  Beeggy (EPIPHANY)  "' >> .bashrc
echo 'echo -e "  Beeggy (EPIPHANY) "' >> .bashrc
echo 'echo -e "  Beeggy (EPIPHANY) "' >> .bashrc
echo 'echo -e "  Beeggy (EPIPHANY) "' >> .bashrc
echo 'echo -e "  Beeggy (EPIPHANY)  "' >> .bashrc
echo 'echo -e "welcome to the server $HOSTNAME" | lolcat' >> .bashrc
echo 'echo -e "Script mod by Beeggy"' >> .bashrc
...
echo "" | tee -a log-install.txt
echo "Auto Script Installer OCS Panels by Beeggy"  | tee -a log-install.txt
echo "                        "  | tee -a log-install.txt
echo "" | tee -a log-install.txt
