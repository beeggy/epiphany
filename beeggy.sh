...
echo 'echo -e "\e[0;34m★→→→TEAM EPIPHANY←←←←★"' >> .bashrc
echo 'echo -e "\e[0;34m★→→→SCRIPT BY BEEGGY←←←★"' >> .bashrc
echo 'echo -e "\e[0;34m★→PANEL BY HIRA,JERZ ,WENZ←★"' >> .bashrc
echo 'echo -e "\e[0;34m★→→AND ALSO MY TEAM←←←★"' >> .bashrc
echo 'echo -e "\e[0;34m★★★★★★★★★★★★★★★★★★"' >> .bashrc
echo -e "\e[94m.  ---------------------------------------------------------------      "
echo -e "\e[94m        OCS Panel Template by  Beeggy (TEAM EPIPHANY)        "
echo -e "\e[94m                                                  "
...
echo 'echo -e "                                                        "' >> .bashrc
echo 'echo -e "\e[94m        OCS Panel Template by Beeggy (TEAM EPIPHANY)        "' >> .bashrc
...
echo -e "\e[94m        OCS Panel Template by Beeggy (TEAM EPIPHANY)        " | tee -a log-install.txt
echo -e "\e[94m                                                  " | tee -a log-install.txt
echo -e "\e[94m                                                  " | tee -a log-install.txt
